...
#define MAX_APPLICATION_SPEED_RPM       15504 /*!< rpm, mechanical */
...
#define PID_SPEED_KP_DEFAULT          2472/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          514/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_CONTROL_MODE           STC_SPEED_MODE /*!< STC_TORQUE_MODE or
                                                        STC_SPEED_MODE */
#define DEFAULT_TARGET_SPEED_RPM      2846
...
#define PHASE1_FINAL_CURRENT           3086
/* Phase 2 */
#define PHASE2_DURATION                6324 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT         (3162*SPEED_UNIT/_RPM)
#define PHASE2_FINAL_CURRENT           3086
/* Phase 3 */
#define PHASE3_DURATION                0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (3162*SPEED_UNIT/_RPM)
#define PHASE3_FINAL_CURRENT           3086
/* Phase 4 */
#define PHASE4_DURATION                0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (3162*SPEED_UNIT/_RPM)
#define PHASE4_FINAL_CURRENT           3086
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (3162*SPEED_UNIT/_RPM)
#define PHASE5_FINAL_CURRENT           3086

#define ENABLE_SL_ALGO_FROM_PHASE      2
/* Sensor-less rev-up sequence */
#define STARTING_ANGLE_DEG             0  /*!< degrees [0...359] */
/* Observer start-up output conditions  */
#define OBS_MINIMUM_SPEED_RPM          2846
